...
assert_file "$TMP/.claude/skills/bugfix-safe/SKILL.md" "bugfix-safe skill created"
assert_file "$TMP/.claude/skills/review-pr-risk/SKILL.md" "review-pr-risk skill created"
